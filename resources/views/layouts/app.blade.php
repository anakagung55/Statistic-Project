...
<body class="bg-gray-100 font-family-karla flex">
    ...
    <div class="container mx-auto">
        <div class="flex justify-center">
            <div class="mb-1 mr-1">
                <a href="{{url('/import')}}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
                    Import Data
                </a>
            </div>
            <div class="mb-1">
                <a href="{{url('/export')}}" class="bg-green-500 hover:bg-green-600 text-white font-bold py-2 px-4 rounded">
                    Export Data
                </a>
            </div>
        </div>
